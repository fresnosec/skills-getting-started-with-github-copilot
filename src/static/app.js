      ...
      Object.entries(activities).forEach(([name, details]) => {
        ...
        if (details.participants && details.participants.length) {
          ...
          details.participants.forEach((p) => {
            // include a hidden remove button that appears on hover
            participantsHTML += `<li><span class="participant-email">${p}</span><button class="participant-remove" data-activity="${encodeURIComponent(
              name
